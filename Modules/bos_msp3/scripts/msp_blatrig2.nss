...
void main() {
	...
	vector struct2 = Vector(215.68, 53.9, 3.0);
	location location1 = Location(struct2, 0.0);
	vector struct4 = Vector(223.05, 55.04, 3.0);
	location location3 = Location(struct4, 0.0);
	vector struct6 = Vector(215.68, 56.26, 3.0);
	...
	if ((oNPC == GetEnteringObject())) {
		...
		CreateObject(1, "mzp_mandalore", Location(Vector(100.24, 67.92, 0.0), 0.0), 0);
