...
void main() {
	...
	vector struct2 = Vector(76.24, 92.21, 0.0);
	location location1 = Location(struct2, 0.0);
	vector struct4 = Vector(77.6, 94.4, 0.0);
	location location3 = Location(struct4, 0.0);
	vector struct6 = Vector(63.52, 111.52, (-1.27));
	location location5 = Location(struct6, 270.0);
	vector struct8 = Vector(60.88, 111.52, (-1.27));
	location location7 = Location(struct8, 270.0);
	vector struct10 = Vector(62.17, 111.52, (-1.27));
	location location9 = Location(struct10, 270.0);
	AssignCommand(oOrn_drix, JumpToLocation(location5));
	AssignCommand(oOrn_walon, JumpToLocation(location7));
	AssignCommand(oOrn_mechanic, JumpToLocation(location9));
	object oMsp_rep = GetObjectByTag("msp_rep", 0);
	object oMsp_rep2 = GetObjectByTag("msp_rep2", 0);
	AssignCommand(oMsp_rep, ActionForceMoveToLocation(location3, 1, 30.0));
	AssignCommand(oMsp_rep2, ActionForceMoveToLocation(location1, 1, 30.0));
	...
	AssignCommand(oMsp_rep, sub1(OBJECT_INVALID));
	AssignCommand(oMsp_rep2, sub1(OBJECT_INVALID));
