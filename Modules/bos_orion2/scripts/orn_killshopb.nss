...
void main() {
	...
	CancelCombat(oOrn_repshoot);
	ChangeToStandardFaction(GetObjectByTag("orn_repshoot", 0), 12);
	ChangeToStandardFaction(GetObjectByTag("orn_shopguy", 0), 11);
	AssignCommand(oOrn_repshoot, sub1(OBJECT_INVALID));
	AssignCommand(oOrn_shopguy, sub1(OBJECT_INVALID));
