...
void main() {
	...
	if ((oCz3_battle11 == GetEnteringObject())) {
		ChangeToStandardFaction(GetObjectByTag("cz3_battle12", 0), 1);
		ChangeToStandardFaction(GetObjectByTag("cz3_battle13", 0), 1);
		ChangeToStandardFaction(GetObjectByTag("cz3_battle14", 0), 1);
		object object11 = GetObjectByTag("cz3_battle12", 0);
		object oCz3_battle13 = GetObjectByTag("cz3_battle13", 0);
		object oCz3_battle14 = GetObjectByTag("cz3_battle14", 0);
		AssignCommand(object11, sub1(OBJECT_INVALID));
