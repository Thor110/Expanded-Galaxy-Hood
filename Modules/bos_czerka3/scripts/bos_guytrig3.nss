...
void main() {
	...
	if ((oCz3_battle11 == GetEnteringObject())) {
		ChangeToStandardFaction(GetObjectByTag("cz3_battle10", 0), 1);
		ChangeToStandardFaction(GetObjectByTag("cz3_battle11", 0), 1);
		...
		ChangeToStandardFaction(GetObjectByTag("cz3_battle3", 0), 1);
		ChangeToStandardFaction(GetObjectByTag("cz3_battle4", 0), 1);
		ChangeToStandardFaction(GetObjectByTag("cz3_battle5", 0), 1);
