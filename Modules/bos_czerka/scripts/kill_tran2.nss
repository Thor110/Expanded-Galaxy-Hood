...
void main() {
	...
	ChangeToStandardFaction(GetObjectByTag("bos_tran", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("bos_asshole", 0), 2);
	ChangeToStandardFaction(GetObjectByTag("bos_assdroid1", 0), 2);
	ChangeToStandardFaction(GetObjectByTag("bos_assdroid2", 0), 2);
