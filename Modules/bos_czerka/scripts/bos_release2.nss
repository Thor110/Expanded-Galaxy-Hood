...
void main() {
	...
	object oBos_prisoner = GetObjectByTag("bos_prisoner", 0);
	ActionDoCommand(DestroyObject(oBos_cage2, 0.0, 0, 0.0));
	string string1 = "gen_shieldbluoff";
	PlaySound(string1);
	DelayCommand(2.0, ChangeToStandardFaction(GetObjectByTag("bos_prisoner", 0), 1));
	DelayCommand(2.5, AssignCommand(oBos_prisoner, sub1(OBJECT_INVALID)));
}
