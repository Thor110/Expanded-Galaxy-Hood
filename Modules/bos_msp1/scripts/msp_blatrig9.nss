...
void main() {
	object oNPC = GetPartyMemberByIndex(0);
	vector struct2 = Vector(42.62, 154.93, 3.0);
	location location1 = Location(struct2, 0.0);
	vector struct4 = Vector(24.96, 154.99, 3.0);
	location location3 = Location(struct4, 0.0);
	vector struct6 = Vector(45.09, 155.58, 6.0);
	location location5 = Location(struct6, 0.0);
	object oMsp_blatrig9 = GetObjectByTag("msp_blatrig9", 0);
	object oMsp_malak = GetObjectByTag("msp_malak", 0);
	if ((oNPC == GetEnteringObject())) {
		object oMsp_mand19 = GetObjectByTag("msp_mand19", 0);
		object oMsp_mand18 = GetObjectByTag("msp_mand18", 0);
		AssignCommand(oMsp_mand19, ActionDoCommand(SetCommandable(0, oMsp_mand19)));
		AssignCommand(oMsp_mand19, ActionForceMoveToLocation(location1, 1, 30.0));
		AssignCommand(oMsp_mand19, ActionForceMoveToLocation(location3, 1, 30.0));
		AssignCommand(oMsp_mand19, ActionDoCommand(SetFacing(0.0)));
		AssignCommand(oMsp_mand18, ActionForceMoveToLocation(location5, 1, 30.0));
		AssignCommand(oMsp_mand18, ChangeToStandardFaction(GetObjectByTag("msp_mand18", 0), 1));
		AssignCommand(oMsp_mand18, sub1(OBJECT_INVALID));
		AssignCommand(oMsp_blatrig9, ActionDoCommand(DestroyObject(oMsp_blatrig9, 0.0, 0, 0.0)));
	}
}
