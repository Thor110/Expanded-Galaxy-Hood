...
void main() {
	object oNPC = GetPartyMemberByIndex(0);
	vector struct2 = Vector(123.32, 161.16, 9.0);
	location location1 = Location(struct2, 0.0);
	vector struct4 = Vector(117.08, 155.74, 9.0);
	location location3 = Location(struct4, 0.0);
	vector struct6 = Vector(20.13, 156.1, 3.0);
	location location5 = Location(struct6, 0.0);
	vector struct8 = Vector(125.93, 160.39, 9.0);
	location location7 = Location(struct8, 0.0);
	vector struct10 = Vector(118.26, 153.74, 9.0);
	location location9 = Location(struct10, 0.0);
	vector struct12 = Vector(20.17, 153.95, 3.0);
	location location11 = Location(struct12, 0.0);
	vector struct14 = Vector(126.39, 160.3, 9.0);
	location location13 = Location(struct14, 0.0);
	vector struct16 = Vector(123.82, 160.3, 9.0);
	location location15 = Location(struct16, 0.0);
	object oMsp_mand1b = GetObjectByTag("msp_mand1b", 0);
	if ((oMsp_mand1b == GetEnteringObject())) {
		object object6 = GetObjectByTag("msp_mand1b", 0);
		object oMsp_mand1c = GetObjectByTag("msp_mand1c", 0);
		object oMand_droid1 = GetObjectByTag("mand_droid1", 0);
		object oMand_droid2 = GetObjectByTag("mand_droid2", 0);
		AssignCommand(oMand_droid1, ActionForceMoveToLocation(location13, 0, 30.0));
		AssignCommand(oMand_droid2, ActionForceMoveToLocation(location15, 0, 30.0));
		...
		CreateObject(1, "msp_mand11", Location(Vector(224.08, 153.57, 0.0), 0.0), 0);
		CreateObject(1, "msp_mand12", Location(Vector(224.15, 155.87, 0.0), 0.0), 0);
	}
}
