...
void main() {
	...
	vector struct4 = Vector(238.96, 97.5, 0.0);
	...
	AssignCommand(oTaris_channa2, ActionUnequipItem(oRWeapItem, 4));
	CancelCombat(oTaris_solomon2);
	CancelCombat(oTaris_channa2);
