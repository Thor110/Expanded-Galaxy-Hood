...
void main() {
	...
	ActionWait(3.0);
	vector struct2 = Vector(235.62, 93.88, 0.0);
	...
	AssignCommand(oTaris_channa2, SetFacingPoint(GetPosition(GetObjectByTag("mand_end1", 0))));
	AssignCommand(oTaris_solomon2, JumpToLocation(location1));
	AssignCommand(oTaris_solomon2, SetLockOrientationInDialog(oTaris_solomon2, 1));
	ChangeToStandardFaction(GetObjectByTag("mand_end1", 0), 2);
	ChangeToStandardFaction(GetObjectByTag("mand_end2", 0), 2);
	ChangeToStandardFaction(GetObjectByTag("mand_end3", 0), 2);
	ChangeToStandardFaction(GetObjectByTag("mand_end4", 0), 2);
	ChangeToStandardFaction(GetObjectByTag("taris_solomon2", 0), 4);
	SetNPCAIStyle(oTaris_solomon2, 1);
	AssignCommand(oTaris_solomon2, sub1(OBJECT_INVALID));
	AssignCommand(oMand_end1, ExecuteScript("k_ai_master", oMand_end1, 1005));
	AssignCommand(oMand_end2, ExecuteScript("k_ai_master", oMand_end2, 1005));
	AssignCommand(oMand_end3, ExecuteScript("k_ai_master", oMand_end3, 1005));
	AssignCommand(oMand_end4, ExecuteScript("k_ai_master", oMand_end4, 1005));
	...
	object oTem_target5 = GetObjectByTag("tem_target5", 0);
	object oTem_target6 = GetObjectByTag("tem_target6", 0);
	object oTem_target7 = GetObjectByTag("tem_target7", 0);
	object oTem_target8 = GetObjectByTag("tem_target8", 0);
	object oTem_target9 = GetObjectByTag("tem_target9", 0);
