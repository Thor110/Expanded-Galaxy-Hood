...
void main() {
	...
	object object27 = GetObjectByTag("wst_charlie", 0);
	...
	AssignCommand(oTem_solomon3, ActionCastFakeSpellAtObject(29, oTem_solomon3, 0));
	DelayCommand(1.0, AssignCommand(oBastila, ActionDoCommand(ApplyEffectToObject(2, effect1, oBastila, 0.0))));
	DelayCommand(1.0, AssignCommand(oBastila, SetCommandable(0, oBastila)));
