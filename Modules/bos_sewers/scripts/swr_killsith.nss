...
void main() {
	...
	ChangeToStandardFaction(GetObjectByTag("swr_sithguard1", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("swr_sithguard2", 0), 1);
	AssignCommand(oSwr_sithguard1, sub1(OBJECT_INVALID));
	AssignCommand(oSwr_sithguard2, sub1(OBJECT_INVALID));
