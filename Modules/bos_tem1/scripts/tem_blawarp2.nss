void main() {
	...
	ActionWait(2.0);
	vector struct2 = Vector(83.32, 73.55, 9.0);
	location location1 = Location(struct2, 180.0);
	vector struct4 = Vector(83.32, 75.07, 9.0);
	location location3 = Location(struct4, 180.0);
	vector struct6 = Vector(83.32, 76.59, 9.0);
	location location5 = Location(struct6, 180.0);
	vector struct8 = Vector(85.52, 75.75, 9.0);
	location location7 = Location(struct8, 180.0);
	vector struct10 = Vector(86.82, 77.01, 9.0);
