...
void main() {
	object oNPC = GetPartyMemberByIndex(0);
	vector struct2 = Vector(36.3, 93.6, 3.0);
	location location1 = Location(struct2, 0.0);
	vector struct4 = Vector(36.19, 56.06, 3.0);
	location location3 = Location(struct4, 0.0);
	vector struct6 = Vector(33.53, 96.14, 9.0);
	location location5 = Location(struct6, 0.0);
	vector struct8 = Vector(33.84, 56.06, 9.0);
	location location7 = Location(struct8, 0.0);
	object oMsp_blatrig2 = GetObjectByTag("msp_blatrig2", 0);
	...
	if ((oNPC == GetEnteringObject())) {
		...
		AssignCommand(oMsp_mand12, ActionForceMoveToLocation(location1, 1, 30.0));
		AssignCommand(oMsp_mand12, ActionForceMoveToLocation(location3, 1, 30.0));
		AssignCommand(oMsp_mand13, ActionForceMoveToLocation(location5, 1, 30.0));
		AssignCommand(oMsp_mand13, ActionForceMoveToLocation(location7, 1, 30.0));
		...
		AssignCommand(oMsp_blatrig2, ActionDoCommand(DestroyObject(oMsp_blatrig2, 0.0, 0, 0.0)));
	}
}
