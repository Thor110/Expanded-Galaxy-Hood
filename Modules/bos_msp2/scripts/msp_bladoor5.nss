...
void main() {
	object oNPC = GetPartyMemberByIndex(0);
	vector struct2 = Vector(74.1, 49.97, 3.0);
	location location1 = Location(struct2, 0.0);
	vector struct4 = Vector(76.48, 49.76, 9.0);
	location location3 = Location(struct4, 0.0);
	object oMsp_blatrig4 = GetObjectByTag("msp_blatrig4", 0);
	object oMsp_blatrig5 = GetObjectByTag("msp_blatrig5", 0);
	object oMsp_blatrig6 = GetObjectByTag("msp_blatrig6", 0);
	object oMsp_blatrig7 = GetObjectByTag("msp_blatrig7", 0);
	object oMsp_mand14 = GetObjectByTag("msp_mand14", 0);
	object oMsp_mand15 = GetObjectByTag("msp_mand15", 0);
	object oMand_droid1 = GetObjectByTag("mand_droid1", 0);
	object oMand_droid2 = GetObjectByTag("mand_droid2", 0);
	AssignCommand(oMand_droid1, ActionForceMoveToLocation(location1, 0, 30.0));
	AssignCommand(oMand_droid2, ActionForceMoveToLocation(location3, 0, 30.0));
	AssignCommand(oMand_droid1, ChangeToStandardFaction(GetObjectByTag("mand_droid1", 0), 1));
	AssignCommand(oMand_droid1, sub1(OBJECT_INVALID));
	AssignCommand(oMand_droid2, ChangeToStandardFaction(GetObjectByTag("mand_droid2", 0), 1));
	AssignCommand(oMand_droid2, sub1(OBJECT_INVALID));
	AssignCommand(oMsp_mand14, ChangeToStandardFaction(GetObjectByTag("msp_mand14", 0), 1));
	AssignCommand(oMsp_mand14, sub1(OBJECT_INVALID));
	AssignCommand(oMsp_mand15, ChangeToStandardFaction(GetObjectByTag("msp_mand15", 0), 1));
	AssignCommand(oMsp_mand15, sub1(OBJECT_INVALID));
	object oMsp_mand12 = GetObjectByTag("msp_mand12", 0);
	object oMsp_mand13 = GetObjectByTag("msp_mand13", 0);
	AssignCommand(oMsp_mand12, ChangeToStandardFaction(GetObjectByTag("msp_mand12", 0), 1));
	AssignCommand(oMsp_mand12, sub1(OBJECT_INVALID));
	AssignCommand(oMsp_mand13, ChangeToStandardFaction(GetObjectByTag("msp_mand13", 0), 1));
	AssignCommand(oMsp_mand13, sub1(OBJECT_INVALID));
	AssignCommand(oMsp_blatrig5, ActionDoCommand(DestroyObject(oMsp_blatrig5, 0.0, 0, 0.0)));
	AssignCommand(oMsp_blatrig4, ActionDoCommand(DestroyObject(oMsp_blatrig4, 0.0, 0, 0.0)));
	AssignCommand(oMsp_blatrig6, ActionDoCommand(DestroyObject(oMsp_blatrig6, 0.0, 0, 0.0)));
	AssignCommand(oMsp_blatrig7, ActionDoCommand(DestroyObject(oMsp_blatrig7, 0.0, 0, 0.0)));
}
