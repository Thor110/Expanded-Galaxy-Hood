...
void main() {
	object oNPC = GetPartyMemberByIndex(0);
	vector struct2 = Vector(73.79, 92.98, 3.0);
	location location1 = Location(struct2, 0.0);
	vector struct4 = Vector(76.52, 93.55, 9.0);
	location location3 = Location(struct4, 0.0);
	object oMsp_blatrig6 = GetObjectByTag("msp_blatrig6", 0);
	object oMsp_blatrig7 = GetObjectByTag("msp_blatrig7", 0);
	object oMsp_blatrig7b = GetObjectByTag("msp_blatrig7b", 0);
	if ((oNPC == GetEnteringObject())) {
		...
		AssignCommand(oMsp_blatrig7b, ActionDoCommand(DestroyObject(oMsp_blatrig7b, 0.0, 0, 0.0)));
	}
}
