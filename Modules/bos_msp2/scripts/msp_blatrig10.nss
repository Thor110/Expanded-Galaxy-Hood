...
void main() {
	object oNPC = GetPartyMemberByIndex(0);
	vector struct2 = Vector(136.24, 53.86, 3.0);
	location location1 = Location(struct2, 0.0);
	vector struct4 = Vector(123.8, 55.96, 3.0);
	location location3 = Location(struct4, 0.0);
	vector struct6 = Vector(133.71, 55.75, 9.0);
	location location5 = Location(struct6, 0.0);
	vector struct8 = Vector(123.8, 54.11, 9.0);
	location location7 = Location(struct8, 0.0);
	object oMsp_blatrig10 = GetObjectByTag("msp_blatrig10", 0);
	object oMsp_blatrig10b = GetObjectByTag("msp_blatrig10b", 0);
	if ((oNPC == GetEnteringObject())) {
		object oMsp_mand16 = GetObjectByTag("msp_mand16", 0);
		object oMsp_mand16b = GetObjectByTag("msp_mand16b", 0);
		AssignCommand(oMsp_mand16, ActionForceMoveToLocation(location1, 1, 30.0));
		AssignCommand(oMsp_mand16, ActionForceMoveToLocation(location3, 1, 30.0));
		AssignCommand(oMsp_mand16b, ActionForceMoveToLocation(location5, 1, 30.0));
		AssignCommand(oMsp_mand16b, ActionForceMoveToLocation(location7, 1, 30.0));
		AssignCommand(oMsp_mand16, ChangeToStandardFaction(GetObjectByTag("msp_mand16", 0), 1));
		AssignCommand(oMsp_mand16, sub1(OBJECT_INVALID));
		AssignCommand(oMsp_mand16b, ChangeToStandardFaction(GetObjectByTag("msp_mand16b", 0), 1));
		AssignCommand(oMsp_mand16b, sub1(OBJECT_INVALID));
		AssignCommand(oMsp_blatrig10, ActionDoCommand(DestroyObject(oMsp_blatrig10, 0.0, 0, 0.0)));
		AssignCommand(oMsp_blatrig10b, ActionDoCommand(DestroyObject(oMsp_blatrig10b, 0.0, 0, 0.0)));
	}
}
