...
void main() {
	ChangeToStandardFaction(GetObjectByTag("bos_torture", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("bos_torture2", 0), 1);
	object oBos_torture = GetObjectByTag("bos_torture", 0);
	object oBos_torture2 = GetObjectByTag("bos_torture2", 0);
	object oPC = GetFirstPC();
	AssignCommand(oBos_torture, sub1(OBJECT_INVALID));
	AssignCommand(oBos_torture2, sub1(OBJECT_INVALID));
}
