...
void main() {
	...
	ChangeToStandardFaction(GetObjectByTag("vision4_bastila", 0), 2);
	ChangeToStandardFaction(GetObjectByTag("vision4_channa", 0), 4);
	AssignCommand(oVision4_bastila, sub1(OBJECT_INVALID));
	AssignCommand(oVision4_channa, sub1(OBJECT_INVALID));
