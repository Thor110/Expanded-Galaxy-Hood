void main() {
	...
	AssignCommand(oMr_invis, ActionTakeItem(GetObjectByTag("ds_revan_robe", 0), GetFirstPC()));
	AssignCommand(oMr_invis, ActionTakeItem(GetObjectByTag("ds_revan_mask", 0), GetFirstPC()));
	AssignCommand(oMr_invis, ActionTakeItem(GetObjectByTag("revan_saber", 0), GetFirstPC()));
}
