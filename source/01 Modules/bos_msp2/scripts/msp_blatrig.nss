...
void main() {
	object oNPC = GetPartyMemberByIndex(0);
	vector struct2 = Vector(36.8, 33.45, 3.0);
	location location1 = Location(struct2, 0.0);
	vector struct4 = Vector(36.39, 36.77, 9.0);
	location location3 = Location(struct4, 0.0);
	vector struct6 = Vector(34.65, 15.18, 9.0);
	location location5 = Location(struct6, 0.0);
	object oMsp_blatrig = GetObjectByTag("msp_blatrig", 0);
	object oMr_invis = GetObjectByTag("mr_invis", 0);
	if ((oNPC == GetEnteringObject())) {
		object oMsp_mand4 = GetObjectByTag("msp_mand4", 0);
		object oMsp_mand5 = GetObjectByTag("msp_mand5", 0);
		object oMsp_mand6 = GetObjectByTag("msp_mand6", 0);
		AssignCommand(oMsp_mand4, ActionForceMoveToLocation(location1, 1, 30.0));
		AssignCommand(oMsp_mand5, ActionForceMoveToLocation(location3, 1, 30.0));
		AssignCommand(oMsp_mand6, ActionForceMoveToLocation(location5, 1, 30.0));
		AssignCommand(oMsp_mand4, ChangeToStandardFaction(GetObjectByTag("msp_mand4", 0), 1));
		AssignCommand(oMsp_mand4, sub1(OBJECT_INVALID));
		AssignCommand(oMsp_mand5, ChangeToStandardFaction(GetObjectByTag("msp_mand5", 0), 1));
		AssignCommand(oMsp_mand5, sub1(OBJECT_INVALID));
		AssignCommand(oMsp_mand6, ChangeToStandardFaction(GetObjectByTag("msp_mand6", 0), 1));
		AssignCommand(oMsp_mand6, sub1(OBJECT_INVALID));
		AssignCommand(oMsp_mand6, SetNPCAIStyle(oMsp_mand6, 4));
		AssignCommand(oMsp_blatrig, ActionDoCommand(DestroyObject(oMsp_blatrig, 0.0, 0, 0.0)));
	}
}
