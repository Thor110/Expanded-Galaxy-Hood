void main() {
	...
	if (((((((((oPC == GetEnteringObject()) && (GetIsObjectValid(oEbo_trig1) == 1)) && (GetIsObjectValid(oEbo_trig2) == 1)) && (GetIsObjectValid(oEbo_trig3) == 1)) && (GetIsObjectValid(oEbo_trig4) == 1)) && (GetIsObjectValid(oEbo_trig5) == 1)) && (GetIsObjectValid(oEbo_trig6) == 1)) && (GetIsObjectValid(oEbo_trig7) == 0))) {
		CreateObject(64, "ebo_trig7", Location(Vector(35.0, 29.0, 1.8), 0.0), 0);
		CreateObject(1, "ebo_solomon", Location(Vector(22.9, 53.77, 1.8), 90.0), 0);
		string string1 = "bos_ebosolo3";
		PlaySound(string1);
