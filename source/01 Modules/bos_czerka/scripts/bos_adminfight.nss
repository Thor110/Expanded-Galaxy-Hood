...
void main() {
	...
	ChangeToStandardFaction(GetObjectByTag("bos_gun1", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("bos_gun2", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("bos_gun3", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("bos_gun4", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("bos_gun5", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("bos_gun6", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("bos_admindroid1", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("bos_admindroid2", 0), 1);
	AssignCommand(oBos_gun1, sub1(OBJECT_INVALID));
	AssignCommand(oBos_gun2, sub1(OBJECT_INVALID));
	AssignCommand(oBos_gun3, sub1(OBJECT_INVALID));
	AssignCommand(oBos_gun4, sub1(OBJECT_INVALID));
	AssignCommand(oBos_gun5, sub1(OBJECT_INVALID));
	AssignCommand(oBos_gun6, sub1(OBJECT_INVALID));
	AssignCommand(oBos_admindroid1, sub1(OBJECT_INVALID));
	AssignCommand(oBos_admindroid2, sub1(OBJECT_INVALID));
}
