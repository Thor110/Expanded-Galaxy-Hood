...
void main() {
	...
	ChangeToStandardFaction(GetObjectByTag("bos_tran", 0), 11);
	ChangeToStandardFaction(GetObjectByTag("bos_asshole", 0), 12);
	ChangeToStandardFaction(GetObjectByTag("bos_assdroid1", 0), 12);
	ChangeToStandardFaction(GetObjectByTag("bos_assdroid2", 0), 12);
	AssignCommand(oBos_tran, sub1(OBJECT_INVALID));
	AssignCommand(oBos_asshole, sub1(OBJECT_INVALID));
	AssignCommand(oBos_assdroid1, sub1(OBJECT_INVALID));
	AssignCommand(oBos_assdroid2, sub1(OBJECT_INVALID));
	vector struct2 = Vector(92.04, 95.21, 0.0);
	location location1 = Location(struct2, 180.0);
	CreateObject(64, "bos_tranthing2", location1, 0);
	SetMinOneHP(oBos_asshole, 1);
}
