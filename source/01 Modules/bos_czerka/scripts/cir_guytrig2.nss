...
void main() {
	...
	if ((GetTag(oEntering) == "bos_walker")) {
		object oBos_walkthing = GetObjectByTag("bos_walkthing", 0);
		if ((GetIsObjectValid(oBos_walkthing) == 0)) {
			CreateObject(64, "bos_walkthing", Location(Vector(70.4, 98.37, 0.0), 0.0), 0);
			AssignCommand(oEntering, ClearAllActions());
			AssignCommand(oEntering, ActionForceMoveToLocation(Location(Vector(32.4, 67.29, 0.0), 0.0), 0, 30.0));
			AssignCommand(oEntering, ActionDoCommand(SetFacing(270.0)));
			AssignCommand(oEntering, ActionWait(3.0));
			AssignCommand(oEntering, ActionDoCommand(SetFacing(110.0)));
			AssignCommand(oEntering, ActionWait(0.5));
			AssignCommand(oEntering, ActionDoCommand(SetFacing(100.0)));
			AssignCommand(oEntering, ActionWait(0.5));
			AssignCommand(oEntering, ActionDoCommand(SetFacing(90.0)));
			AssignCommand(oEntering, ActionWait(0.5));
			AssignCommand(oEntering, ActionDoCommand(SetFacing(80.0)));
			AssignCommand(oEntering, ActionWait(0.5));
			AssignCommand(oEntering, ActionDoCommand(SetFacing(70.0)));
			AssignCommand(oEntering, ActionWait(0.5));
			AssignCommand(oEntering, ActionDoCommand(SetFacing(60.0)));
			AssignCommand(oEntering, ActionWait(0.5));
			AssignCommand(oEntering, ActionDoCommand(SetFacing(50.0)));
			AssignCommand(oEntering, ActionWait(2.0));
			AssignCommand(oEntering, ActionDoCommand(SetFacing(270.0)));
			AssignCommand(oEntering, ActionWait(2.0));
			AssignCommand(oEntering, ActionPlayAnimation(11, 1.0, 3.0));
