...
void main() {
	...
	object object23 = GetObjectByTag("tun_guy", 0);
	object object25 = GetObjectByTag("tun_guy2", 0);
	object oSg1_lol = GetObjectByTag("sg1_lol", 0);
	if (((((((GetIsObjectValid(oSg1_jedi1) == 0) && (GetIsObjectValid(oSg1_jedi2) == 0)) && (GetIsObjectValid(oSg1_jedi3) == 0)) && (GetIsObjectValid(oSg1_jedi4) == 0)) && (GetIsObjectValid(oSg1_lol) == 1)) && (GetIsObjectValid(oTem_bla) == 0))) {
		SetPlotFlag(oSg1_sin, 0);
		sub1(oSg1_sin, 3.0);
		AssignCommand(oTun_guy, ActionStartConversation(oTun_guy2, "sg1_sin2", 0, 0, 0, "", "", "", "", "", "", 0));
