...
void main() {
	...
	ChangeToStandardFaction(GetObjectByTag("sg4_hk47", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("sg4_t3m4", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("sg4_canderous", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("sg4_carth", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("sg4_bastila", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("sg4_mission", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("sg4_zaalbar", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("sg4_jolee", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("sg4_channa", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("sg4_juhani", 0), 1);
	...
	DelayCommand(1.0, ExecuteScript("k_ai_master", oSg4_hk47, 1005));
	DelayCommand(1.0, ExecuteScript("k_ai_master", oSg4_t3m4, 1005));
	DelayCommand(1.0, ExecuteScript("k_ai_master", oSg4_canderous, 1005));
	DelayCommand(1.0, ExecuteScript("k_ai_master", oSg4_carth, 1005));
	DelayCommand(1.0, ExecuteScript("k_ai_master", oSg4_bastila, 1005));
	DelayCommand(1.0, ExecuteScript("k_ai_master", oSg4_mission, 1005));
	DelayCommand(1.0, ExecuteScript("k_ai_master", oSg4_zaalbar, 1005));
	DelayCommand(1.0, ExecuteScript("k_ai_master", oSg4_jolee, 1005));
	DelayCommand(1.0, ExecuteScript("k_ai_master", oSg4_juhani, 1005));
	DelayCommand(1.0, ExecuteScript("k_ai_master", oSg4_channa, 1005));
	AssignCommand(oSg4_hk47, sub1(OBJECT_INVALID));
	AssignCommand(oSg4_t3m4, sub1(OBJECT_INVALID));
	AssignCommand(oSg4_canderous, sub1(OBJECT_INVALID));
	AssignCommand(oSg4_carth, sub1(OBJECT_INVALID));
	AssignCommand(oSg4_bastila, sub1(OBJECT_INVALID));
	AssignCommand(oSg4_mission, sub1(OBJECT_INVALID));
	AssignCommand(oSg4_zaalbar, sub1(OBJECT_INVALID));
	AssignCommand(oSg4_jolee, sub1(OBJECT_INVALID));
	AssignCommand(oSg4_juhani, sub1(OBJECT_INVALID));
	AssignCommand(oSg4_channa, sub1(OBJECT_INVALID));
