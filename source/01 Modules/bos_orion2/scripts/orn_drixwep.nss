...
void main() {
	...
	object object5 = CreateItemOnObject("g_w_vbroswrd01", oOrn_drix, 1);
	object oRWeapItem = GetItemInSlot(4, oOrn_drix);
	AssignCommand(oOrn_drix, ActionUnequipItem(oRWeapItem, 4));
	AssignCommand(oOrn_drix, ActionEquipItem(object5, 4, 0));
