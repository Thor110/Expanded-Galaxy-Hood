...
void main() {
	...
	SetMinOneHP(oOrn_shopguy, 0);
	ChangeToStandardFaction(GetObjectByTag("orn_mechanic", 0), 5);
	ChangeToStandardFaction(GetObjectByTag("orn_drix", 0), 5);
	ChangeToStandardFaction(GetObjectByTag("orn_walon", 0), 5);
	ChangeToStandardFaction(GetObjectByTag("msp_repstand", 0), 5);
	ChangeToStandardFaction(GetObjectByTag("msp_repstand2", 0), 5);
	ChangeToStandardFaction(GetObjectByTag("msp_repstand3", 0), 5);
	ChangeToStandardFaction(GetObjectByTag("msp_repstand4", 0), 5);
	...
	AssignCommand(oOrn_repshoot, ClearAllEffects());
	AssignCommand(oMsp_repstand, ClearAllEffects());
	AssignCommand(oMsp_repstand2, ClearAllEffects());
	AssignCommand(oMsp_repstand3, ClearAllEffects());
	AssignCommand(oMsp_repstand4, ClearAllEffects());
	AssignCommand(oMsp_repstand, sub1(OBJECT_INVALID));
	AssignCommand(oMsp_repstand2, sub1(OBJECT_INVALID));
	AssignCommand(oMsp_repstand3, sub1(OBJECT_INVALID));
	AssignCommand(oMsp_repstand4, sub1(OBJECT_INVALID));
	object object20 = GetObjectByTag("orn_repshoot", 0);
	object object22 = CreateItemOnObject("g_w_vbroswrd01", object20, 1);
	object oRWeapItem = GetItemInSlot(4, object20);
	AssignCommand(object20, ActionUnequipItem(oRWeapItem, 4));
	AssignCommand(object20, ActionEquipItem(object22, 4, 0));
