...
void main() {
	...
	object object5 = CreateItemOnObject("bos_sinarmour", oPC, 1);
	object object7 = CreateItemOnObject("bos_sinsword", oPC, 1);
	effect efSpeedInc = EffectMovementSpeedIncrease(50);
	ActionDoCommand(ApplyEffectToObject(2, efSpeedInc, oPC, 0.0));
	AssignCommand(oPC, ActionEquipItem(object5, 1, 0));
	AssignCommand(oPC, ActionEquipItem(object7, 4, 0));
}
