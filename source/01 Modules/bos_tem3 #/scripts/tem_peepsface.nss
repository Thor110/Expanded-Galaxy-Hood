void main() {
	...
	AssignCommand(oPC, SetFacingPoint(GetPosition(GetObjectByTag("bastila", 0))));
	AssignCommand(oPC, SetLockOrientationInDialog(oPC, 1));
	AssignCommand(oTem_mechanic, SetFacingPoint(GetPosition(GetObjectByTag("bastila", 0))));
	AssignCommand(oTem_mechanic, SetLockOrientationInDialog(oTem_mechanic, 1));
	AssignCommand(oWst_charlie, SetFacingPoint(GetPosition(GetObjectByTag("bastila", 0))));
	...
	AssignCommand(oCand, SetFacingPoint(GetPosition(GetObjectByTag("bastila", 0))));
	AssignCommand(oCand, SetLockOrientationInDialog(oCand, 1));
	AssignCommand(oCarth, SetFacingPoint(GetPosition(GetObjectByTag("bastila", 0))));
	AssignCommand(oCarth, SetLockOrientationInDialog(oCarth, 1));
	AssignCommand(oHK47, SetFacingPoint(GetPosition(GetObjectByTag("bastila", 0))));
	AssignCommand(oHK47, SetLockOrientationInDialog(oHK47, 1));
	AssignCommand(oJolee, SetFacingPoint(GetPosition(GetObjectByTag("bastila", 0))));
	AssignCommand(oJolee, SetLockOrientationInDialog(oJolee, 1));
	AssignCommand(oJuhani, SetFacingPoint(GetPosition(GetObjectByTag("bastila", 0))));
	AssignCommand(oJuhani, SetLockOrientationInDialog(oJuhani, 1));
	AssignCommand(oMission, SetFacingPoint(GetPosition(GetObjectByTag("bastila", 0))));
	AssignCommand(oMission, SetLockOrientationInDialog(oMission, 1));
	AssignCommand(oT3M4, SetFacingPoint(GetPosition(GetObjectByTag("bastila", 0))));
	AssignCommand(oT3M4, SetLockOrientationInDialog(oT3M4, 1));
	AssignCommand(oZaalbar, SetFacingPoint(GetPosition(GetObjectByTag("bastila", 0))));
