...
void main() {
	...
	if ((GetGlobalNumber("Tar_ZelkaRm") == 92)) {
		object object9 = GetObjectByTag("bastila", 0);
		object oRWeapItem = GetItemInSlot(4, object9);
		object oLWeapItem = GetItemInSlot(5, object9);
		AssignCommand(object9, ActionPlayAnimation(22, 1.0, 7.0));
	...
	if (((GetGlobalNumber("Tar_ZelkaRm") == 93) && (GetIsObjectValid(oTem_bla) == 1))) {
		AssignCommand(oBastila, ActionPlayAnimation(22, 1.0, 7.0));
		object object16 = GetObjectByTag("bastila", 0);
		object oOrn_kobayashi = GetObjectByTag("orn_kobayashi", 0);
		object oTem_target2 = GetObjectByTag("tem_target2", 0);
		effect efBeam = EffectBeam(2029, oTem_target2, 0, 0);
		effect effect3 = EffectBeam(2029, object16, 0, 0);
		effect effect5 = EffectBeam(2037, oTem_target2, 0, 0);
		effect effect7 = EffectBeam(2037, object16, 0, 0);
		...
		ApplyEffectToObject(1, efBeam, object16, 7.0);
		ApplyEffectToObject(1, effect5, object16, 7.0);
		if ((GetIsObjectValid(oTem_bla2) == 1)) {
			...
			AssignCommand(oTem_bla2, ActionDoCommand(DestroyObject(oTem_bla2, 0.0, 0, 0.0)));
		}
