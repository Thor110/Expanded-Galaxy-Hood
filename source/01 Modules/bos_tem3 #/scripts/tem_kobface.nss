void main() {
	...
	AssignCommand(oOrn_kobayashi, SetFacingPoint(GetPosition(GetObjectByTag("tem_mechanic", 0))));
	AssignCommand(oOrn_kobayashi, SetLockOrientationInDialog(oOrn_kobayashi, 0));
