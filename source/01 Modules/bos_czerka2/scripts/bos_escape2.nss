...
void main() {
	ChangeToStandardFaction(GetObjectByTag("bos_prisoner1", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("bos_prisoner2", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("bos_prisoner3", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("bos_prisoner4", 0), 1);
	object oBos_prisoner1 = GetObjectByTag("bos_prisoner1", 0);
	object oBos_prisoner2 = GetObjectByTag("bos_prisoner2", 0);
	object oBos_prisoner3 = GetObjectByTag("bos_prisoner3", 0);
	object oBos_prisoner4 = GetObjectByTag("bos_prisoner4", 0);
	object oPC = GetFirstPC();
	GiveXPToCreature(GetFirstPC(), 500);
	SetMinOneHP(oBos_prisoner2, 0);
	AssignCommand(oBos_prisoner1, sub1(OBJECT_INVALID));
	AssignCommand(oBos_prisoner2, sub1(OBJECT_INVALID));
	AssignCommand(oBos_prisoner3, sub1(OBJECT_INVALID));
	AssignCommand(oBos_prisoner4, sub1(OBJECT_INVALID));
	SetGlobalNumber("Tar_PazNik", 85);
}
