...
void main() {
	...
	AssignCommand(oNPC, JumpToLocation(Location(Vector((-66.4), (-79.04), 0.0), 90.0)));
	object oArea = GetArea(OBJECT_SELF);
	int int1 = 24;
	sub1(GetFirstPC(), GetObjectByTag("bos_storage", 0));
	object object7 = CreateItemOnObject("bos_sinarmour", oNPC, 1);
	object object9 = CreateItemOnObject("bos_sinsword", oNPC, 1);
	AssignCommand(oNPC, ActionEquipItem(object7, 1, 0));
	DelayCommand(3.0, AssignCommand(oNPC, ActionEquipItem(object9, 4, 0)));
