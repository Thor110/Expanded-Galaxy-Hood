...
void main() {
	object oNPC = GetPartyMemberByIndex(0);
	vector struct2 = Vector(210.02, 176.42, 3.0);
	location location1 = Location(struct2, 0.0);
	vector struct4 = Vector(209.92, 173.97, 3.0);
	location location3 = Location(struct4, 0.0);
	object oMsp_mand7 = GetObjectByTag("msp_mand7", 0);
	object oMsp_mand8 = GetObjectByTag("msp_mand8", 0);
	object oMsp_blatrig3 = GetObjectByTag("msp_blatrig3", 0);
	object oMsp_blatrig3b = GetObjectByTag("msp_blatrig3b", 0);
	object oMsp_blatrig3r = GetObjectByTag("msp_blatrig3r", 0);
	object oMsp_blatrig3rb = GetObjectByTag("msp_blatrig3rb", 0);
	if ((oNPC == GetEnteringObject())) {
		AssignCommand(oMsp_mand7, ActionForceMoveToLocation(location1, 1, 30.0));
		AssignCommand(oMsp_mand8, ActionForceMoveToLocation(location3, 1, 30.0));
		AssignCommand(oMsp_mand7, ChangeToStandardFaction(GetObjectByTag("msp_mand7", 0), 1));
		AssignCommand(oMsp_mand7, sub1(OBJECT_INVALID));
		AssignCommand(oMsp_mand8, ChangeToStandardFaction(GetObjectByTag("msp_mand8", 0), 1));
		AssignCommand(oMsp_mand8, sub1(OBJECT_INVALID));
		AssignCommand(oMsp_blatrig3, ActionDoCommand(DestroyObject(oMsp_blatrig3, 0.0, 0, 0.0)));
		AssignCommand(oMsp_blatrig3b, ActionDoCommand(DestroyObject(oMsp_blatrig3b, 0.0, 0, 0.0)));
		AssignCommand(oMsp_blatrig3r, ActionDoCommand(DestroyObject(oMsp_blatrig3r, 0.0, 0, 0.0)));
		AssignCommand(oMsp_blatrig3rb, ActionDoCommand(DestroyObject(oMsp_blatrig3rb, 0.0, 0, 0.0)));
	}
}
