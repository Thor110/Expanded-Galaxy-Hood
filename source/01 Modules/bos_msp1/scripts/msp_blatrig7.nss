...
void main() {
	...
	if ((oNPC == GetEnteringObject())) {
		...
		object oMsp_door2 = GetObjectByTag("msp_door2", 0);
		if (((GetIsObjectValid(oMsp_door) == 1) && (GetIsObjectValid(oMsp_door2) == 0))) {
			object object12 = GetObjectByTag("msp_door", 0);
			object oMsp_malak = GetObjectByTag("msp_malak", 0);
			object oBastila = GetObjectByTag("bastila", 0);
			AssignCommand(object12, ActionDoCommand(SetCommandable(1, oBastila)));
			AssignCommand(object12, ActionDoCommand(SetCommandable(1, oMsp_malak)));
			SetSoloMode(1);
			AssignCommand(object12, ActionStartConversation(GetFirstPC(), "msp_panel2", 0, 0, 0, "", "", "", "", "", "", 0));
		}
		if ((GetIsObjectValid(oMsp_door2) == 1)) {
			vector struct2 = Vector(118.83, 154.05, 9.0);
			location location1 = Location(struct2, 0.0);
			vector struct4 = Vector(276.18, 155.94, 9.0);
			location location3 = Location(struct4, 0.0);
			object oMsp_mand15 = GetObjectByTag("msp_mand15", 0);
			object oMsp_mand1 = GetObjectByTag("msp_mand1", 0);
			AssignCommand(oMsp_mand15, ActionForceMoveToLocation(location1, 1, 30.0));
			...
			SoundObjectSetVolume(oMsp_call, 0);
