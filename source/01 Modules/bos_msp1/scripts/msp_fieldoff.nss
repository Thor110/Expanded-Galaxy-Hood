...
void main() {
	...
	SoundObjectSetVolume(oBos_cage, 0);
	object oMsp_field = GetObjectByTag("msp_field", 0);
	AssignCommand(oMsp_field, SetLocked(oMsp_field, 0));
	AssignCommand(oMsp_field, ActionOpenDoor(oMsp_field));
	object oMsp_mand19 = GetObjectByTag("msp_mand19", 0);
	AssignCommand(oMsp_mand19, ChangeToStandardFaction(GetObjectByTag("msp_mand19", 0), 1));
	AssignCommand(oMsp_mand19, sub1(OBJECT_INVALID));
