...
void main() {
	object oNPC = GetPartyMemberByIndex(0);
	vector struct2 = Vector(148.35, 153.86, 9.0);
	location location1 = Location(struct2, 0.0);
	vector struct4 = Vector(144.62, 156.69, 9.0);
	...
	if ((oNPC == GetEnteringObject())) {
		object oMsp_topdoor = GetObjectByTag("msp_topdoor", 0);
		AssignCommand(oMsp_topdoor, ActionOpenDoor(oMsp_topdoor));
		object oMsp_topdoor2 = GetObjectByTag("msp_topdoor2", 0);
		AssignCommand(oMsp_topdoor2, ActionOpenDoor(oMsp_topdoor2));
		object oMsp_topdoor3 = GetObjectByTag("msp_topdoor3", 0);
		AssignCommand(oMsp_topdoor3, ActionOpenDoor(oMsp_topdoor3));
		object oMsp_mand9 = GetObjectByTag("msp_mand9", 0);
		object oMsp_mand10 = GetObjectByTag("msp_mand10", 0);
		AssignCommand(oMsp_mand9, ActionForceMoveToLocation(location1, 1, 30.0));
		AssignCommand(oMsp_mand10, ActionForceMoveToLocation(location3, 1, 30.0));
		AssignCommand(oMsp_mand9, ChangeToStandardFaction(GetObjectByTag("msp_mand9", 0), 1));
		AssignCommand(oMsp_mand9, sub1(OBJECT_INVALID));
		AssignCommand(oMsp_mand10, ChangeToStandardFaction(GetObjectByTag("msp_mand10", 0), 1));
		AssignCommand(oMsp_mand10, sub1(OBJECT_INVALID));
		AssignCommand(oMr_invis, ActionCloseDoor(oMsp_topdoor));
