...
void main() {
	...
	if ((GetGlobalNumber("Tar_PazVulk") == 10)) {
		AddPartyMember(1, GetObjectByTag("Cand", 0));
	}
	if ((GetGlobalNumber("Tar_PazVulk") == 11)) {
		AddPartyMember(2, GetObjectByTag("Cand", 0));
	}
	if ((GetGlobalNumber("Tar_PazVulk") == 12)) {
		AddPartyMember(3, GetObjectByTag("HK47", 0));
	}
	...
	if ((GetGlobalNumber("Tar_PazVulk") == 15)) {
		AddPartyMember(6, GetObjectByTag("Mission", 0));
	}
	if ((GetGlobalNumber("Tar_PazVulk") == 16)) {
		AddPartyMember(7, GetObjectByTag("T3-M4", 0));
	}
	if ((GetGlobalNumber("Tar_PazVulk") == 17)) {
		AddPartyMember(8, GetObjectByTag("Zaalbar", 0));
	}
}
