void main() {
	...
	vector struct2 = Vector(120.17, 64.42, 0.0);
	location location1 = Location(struct2, 0.0);
	vector struct4 = Vector(122.83, 64.42, 0.0);
	...
	CreateObject(1, "tem_ghost7", Location(Vector(120.17, 64.42, 0.0), 90.0), 0);
	CreateObject(1, "tem_ghost8", Location(Vector(122.83, 64.42, 0.0), 90.0), 0);
