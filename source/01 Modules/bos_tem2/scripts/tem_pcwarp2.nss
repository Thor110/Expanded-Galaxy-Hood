...
void main() {
	...
	vector struct2 = Vector(188.36, 55.14, 0.0);
	location location1 = Location(struct2, 270.0);
	vector struct4 = Vector(187.93, 56.01, 9.0);
	...
	AssignCommand(oCand, JumpToLocation(location3));
	AssignCommand(oCarth, JumpToLocation(location3));
	AssignCommand(oHK47, JumpToLocation(location3));
	AssignCommand(oJolee, JumpToLocation(location3));
	AssignCommand(oJuhani, JumpToLocation(location3));
	AssignCommand(oMission, JumpToLocation(location3));
	AssignCommand(oT3M4, JumpToLocation(location3));
	AssignCommand(oZaalbar, JumpToLocation(location3));
}
