...
void main() {
	...
	if (((oPC == GetEnteringObject()) && (GetGlobalNumber("Tar_ZelkaRm") == 91))) {
		object oTem_czerka1 = GetObjectByTag("tem_czerka1", 0);
		vector struct2 = Vector(32.49, 72.74, 3.19);
		location location1 = Location(struct2, 0.0);
		vector struct4 = Vector(30.57, 54.78, 3.19);
		location location3 = Location(struct4, 0.0);
		vector struct6 = Vector(21.63, 55.06, 3.19);
		location location5 = Location(struct6, 0.0);
		vector struct8 = Vector(31.88, 55.06, 3.19);
		location location7 = Location(struct8, 0.0);
		vector struct10 = Vector(32.05, 73.09, 3.19);
		location location9 = Location(struct10, 0.0);
		vector struct12 = Vector(49.65, 72.97, 3.19);
		location location11 = Location(struct12, 0.0);
		AssignCommand(oTem_czerka1, ActionForceMoveToLocation(location1, 1, 30.0));
		AssignCommand(oTem_czerka1, ActionForceMoveToLocation(location3, 1, 30.0));
		AssignCommand(oTem_czerka1, ActionForceMoveToLocation(location5, 1, 30.0));
		AssignCommand(oTem_czerka1, ActionDoCommand(ActionWait(2.0)));
		AssignCommand(oTem_czerka1, ActionPlayAnimation(10, 1.0, 1.0));
		AssignCommand(oTem_czerka1, ActionDoCommand(ActionWait(2.0)));
		AssignCommand(oTem_czerka1, ActionForceMoveToLocation(location7, 1, 30.0));
		AssignCommand(oTem_czerka1, ActionForceMoveToLocation(location9, 1, 30.0));
		AssignCommand(oTem_czerka1, ActionForceMoveToLocation(location11, 1, 30.0));
		AssignCommand(oTem_czerka1, ActionDoCommand(sub1()));
		object oTem_talk1a = GetObjectByTag("tem_talk1a", 0);
		object oTem_talk1b = GetObjectByTag("tem_talk1b", 0);
		AssignCommand(oTem_talk1a, ActionStartConversation(oTem_talk1b, "tem_talk1", 0, 0, 1, "", "", "", "", "", "", 0));
