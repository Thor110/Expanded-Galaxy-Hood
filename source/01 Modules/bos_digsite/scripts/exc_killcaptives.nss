...
void main() {
	...
	ChangeToStandardFaction(oExc_prisoner1, 1);
	ChangeToStandardFaction(oExc_prisoner2, 1);
	ChangeToStandardFaction(oExc_prisoner3, 1);
	sub1(GetPCSpeaker());
	SetMinOneHP(oExc_prisoner1, 0);
	SetMinOneHP(oExc_prisoner2, 0);
	SetMinOneHP(oExc_prisoner3, 0);
}
