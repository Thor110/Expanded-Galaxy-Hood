...
void main() {
	...
	object oExc_droid = GetObjectByTag("exc_droid", 0);
	vector struct2 = Vector(74.63, 86.67, 3.19);
	location location1 = Location(struct2, 0.0);
	AssignCommand(oExc_exeden, ActionForceMoveToLocation(location1, 0, 30.0));
	AssignCommand(oExc_exeden, ActionDoCommand(DestroyObject(oExc_exeden, 0.0, 1, 0.0)));
	AssignCommand(oExc_droid, SetLockOrientationInDialog(oExc_droid, 1));
	AssignCommand(oExc_torture, ActionDoCommand(ActionWait(2.0)));
