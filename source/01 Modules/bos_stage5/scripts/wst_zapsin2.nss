...
void main() {
	...
	AssignCommand(oTem_sin, ActionDoCommand(SetFacing(180.0)));
	...
	ApplyEffectToObject(1, efBeam, oTem_sin, 60.0);
	ApplyEffectToObject(1, effect7, oTem_sin, 60.0);
	ApplyEffectToObject(1, effect9, oTem_sin, 60.0);
	ApplyEffectToObject(1, effect11, oTem_sin, 60.0);
	AssignCommand(oTem_sin, sub1(oTem_sin, 60.0));
	AssignCommand(oTem_sin, ActionPlayAnimation(21, 1.0, 60.0));
