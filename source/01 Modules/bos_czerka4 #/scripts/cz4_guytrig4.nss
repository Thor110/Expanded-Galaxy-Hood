...
void main() {
	...
	object oCz4_bla2 = GetObjectByTag("cz4_bla2", 0);
	vector struct2 = Vector(70.09, 89.86, 0.0);
	location location1 = Location(struct2, 0.0);
	vector struct4 = Vector(70.12, 95.22, 0.0);
	location location3 = Location(struct4, 0.0);
	vector struct6 = Vector(70.89, 95.01, 0.0);
	location location5 = Location(struct6, 0.0);
	vector struct8 = Vector(70.56, 91.04, 0.0);
	location location7 = Location(struct8, 0.0);
	vector struct10 = Vector(66.21, 90.71, 0.0);
	location location9 = Location(struct10, 0.0);
	if ((GetIsObjectValid(oCz4_bla2) == 1)) {
		if ((GetTag(oEntering) == "cz4_walker3")) {
			AssignCommand(oCz4_bla2, ActionDoCommand(DestroyObject(oCz4_bla2, 0.0, 0, 0.0)));
			AssignCommand(oEntering, ClearAllActions());
			AssignCommand(oEntering, ActionMoveToLocation(location1, 0));
			AssignCommand(oEntering, ActionMoveToLocation(location3, 0));
			AssignCommand(oEntering, ActionMoveToLocation(location5, 0));
			AssignCommand(oEntering, ActionWait(2.0));
			AssignCommand(oEntering, ActionPlayAnimation(11, 1.0, 1.0));
			AssignCommand(oEntering, ActionWait(5.0));
			AssignCommand(oEntering, ActionPlayAnimation(10, 1.0, 1.0));
			AssignCommand(oEntering, ActionWait(5.0));
			AssignCommand(oEntering, ActionPlayAnimation(1, 1.0, 15.0));
			AssignCommand(oEntering, ActionWait(2.0));
			AssignCommand(oEntering, ActionPlayAnimation(11, 1.0, 1.0));
			AssignCommand(oEntering, ActionWait(3.0));
			AssignCommand(oEntering, ActionPlayAnimation(24, 1.0, 20.0));
			AssignCommand(oEntering, ActionWait(5.0));
			AssignCommand(oEntering, ActionPlayAnimation(10, 1.0, 1.0));
			AssignCommand(oEntering, ActionMoveToLocation(location7, 0));
			AssignCommand(oEntering, ActionMoveToLocation(location9, 0));
			AssignCommand(oEntering, ActionDoCommand(sub1()));
		}
	}
}
