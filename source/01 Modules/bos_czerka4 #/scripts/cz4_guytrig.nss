...
void main() {
	...
	vector struct2 = Vector(72.89, 78.52, 0.0);
	location location1 = Location(struct2, 0.0);
	if ((GetTag(oEntering) == "cz4_walker")) {
		...
		AssignCommand(oEntering, ActionPlayAnimation(15, 1.0, 10.0));
		AssignCommand(oEntering, ActionPlayAnimation(24, 1.0, 15.0));
		AssignCommand(oEntering, ActionPlayAnimation(15, 1.0, 10.0));
