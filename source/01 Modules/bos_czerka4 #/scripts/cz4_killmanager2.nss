...
void main() {
	...
	ChangeToStandardFaction(GetObjectByTag("cz4_gangtlkr1b", 0), 2);
	ChangeToStandardFaction(GetObjectByTag("cz4_gangtlkr2b", 0), 2);
	ChangeToStandardFaction(GetObjectByTag("cz4_gangtlkr3b", 0), 2);
	ChangeToStandardFaction(GetObjectByTag("cz4_gangtlkr4b", 0), 2);
	ChangeToStandardFaction(GetObjectByTag("cz4_gangwaiter1b", 0), 2);
	ChangeToStandardFaction(GetObjectByTag("cz4_gangwaiter2b", 0), 2);
	...
	SetMinOneHP(oCz4_gangwaiter2b, 1);
}
