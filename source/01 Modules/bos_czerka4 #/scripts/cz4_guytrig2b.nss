...
void main() {
	...
	vector struct2 = Vector(69.79, 60.27, 0.0);
	location location1 = Location(struct2, 0.0);
	vector struct4 = Vector(69.95, 56.81, 0.0);
	location location3 = Location(struct4, 0.0);
	vector struct6 = Vector(67.15, 56.75, 0.0);
	location location5 = Location(struct6, 0.0);
	if ((GetTag(oExiting) == "cz4_walker3")) {
		object oCz4_guydoor = GetObjectByTag("cz4_guydoor", 0);
		object oCz4_bla = GetObjectByTag("cz4_bla", 0);
		AssignCommand(oCz4_guydoor, ActionCloseDoor(oCz4_guydoor));
		if ((GetIsObjectValid(oCz4_bla) == 1)) {
			object object7 = GetObjectByTag("cz4_bla", 0);
			AssignCommand(object7, ActionDoCommand(DestroyObject(object7, 0.0, 0, 0.0)));
			AssignCommand(oExiting, ClearAllActions());
			AssignCommand(oExiting, ActionMoveToLocation(location3, 0));
			AssignCommand(oExiting, ActionMoveToLocation(location5, 0));
			AssignCommand(oExiting, ActionPlayAnimation(15, 1.0, 15.0));
			AssignCommand(oExiting, ActionPlayAnimation(24, 1.0, 15.0));
			AssignCommand(oExiting, ActionPlayAnimation(15, 1.0, 15.0));
			AssignCommand(oExiting, ActionMoveToLocation(location3, 0));
			AssignCommand(oExiting, ActionWait(1.0));
			AssignCommand(oExiting, ActionMoveToLocation(location1, 0));
			AssignCommand(oExiting, ActionDoCommand(SetFacing(270.0)));
			AssignCommand(oExiting, ActionPlayAnimation(24, 1.0, 20.0));
			AssignCommand(oExiting, ActionDoCommand(sub1()));
		}
	}
}
