...
void main() {
	...
	vector struct2 = Vector(231.86, 91.32, 0.0);
	location location1 = Location(struct2, 0.0);
	object oDroidshop = GetObjectByTag("droidshop", 0);
	AssignCommand(oDroidshop, ActionOpenDoor(oDroidshop));
	...
	AssignCommand(oTaris_fighter1, ActionDoCommand(DestroyObject(oTaris_fighter1, 0.0, 0, 0.0)));
	AssignCommand(oTaris_fighter2, ActionDoCommand(DestroyObject(oTaris_fighter2, 0.0, 0, 0.0)));
	AssignCommand(oTaris_fighter3, ActionDoCommand(DestroyObject(oTaris_fighter3, 0.0, 0, 0.0)));
	AssignCommand(oTaris_fighter4, ActionDoCommand(DestroyObject(oTaris_fighter4, 0.0, 0, 0.0)));
	AssignCommand(oTaris_fighter5, ActionDoCommand(DestroyObject(oTaris_fighter5, 0.0, 0, 0.0)));
	AssignCommand(oTaris_fighter6, ActionDoCommand(DestroyObject(oTaris_fighter6, 0.0, 0, 0.0)));
	AssignCommand(oTaris_fighter7, ActionDoCommand(DestroyObject(oTaris_fighter7, 0.0, 0, 0.0)));
	AssignCommand(oTaris_fighter8, ActionDoCommand(DestroyObject(oTaris_fighter8, 0.0, 0, 0.0)));
	SetNPCAIStyle(oTaris_solomon2, 1);
	AssignCommand(oTaris_solomon2, ActionForceMoveToLocation(location1, 1, 30.0));
