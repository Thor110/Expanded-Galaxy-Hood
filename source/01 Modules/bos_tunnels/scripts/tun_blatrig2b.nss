...
void main() {
	...
	vector struct2 = Vector(174.81, 140.85, 5.77);
	location location1 = Location(struct2, 0.0);
	vector struct4 = Vector(194.44, 144.68, 5.77);
	...
	if ((oNPC == GetEnteringObject())) {
		...
		AssignCommand(oTun_channa2b, ActionDoCommand(SetCommandable(0, oTun_channa2b)));
		AssignCommand(oTun_channa2b, ActionForceMoveToLocation(location1, 1, 30.0));
		AssignCommand(oTun_channa2b, ActionForceMoveToLocation(location3, 1, 30.0));
