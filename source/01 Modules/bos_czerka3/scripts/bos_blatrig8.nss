...
void main() {
	...
	if ((oNPC == GetEnteringObject())) {
		...
		if ((GetIsObjectValid(oCz3_main6) == 1)) {
			vector struct2 = Vector(67.07, 83.7, 0.0);
			location location1 = Location(struct2, 0.0);
			vector struct4 = Vector(55.25, 84.36, 0.0);
			location location3 = Location(struct4, 0.0);
			vector struct6 = Vector(54.44, 87.51, 0.0);
			location location5 = Location(struct6, 0.0);
			object oCz3_battle12 = GetObjectByTag("cz3_battle12", 0);
			object oCz3_battle13 = GetObjectByTag("cz3_battle13", 0);
			object oCz3_battle14 = GetObjectByTag("cz3_battle14", 0);
			CreateObject(1, "cz3_runneeeeeer", Location(Vector(112.34, 87.5, 0.0), 270.0), 0);
			AssignCommand(oCz3_battle12, ActionForceMoveToLocation(location1, 1, 30.0));
			AssignCommand(oCz3_battle13, ActionForceMoveToLocation(location3, 1, 30.0));
			AssignCommand(oCz3_battle14, ActionForceMoveToLocation(location5, 1, 30.0));
			AssignCommand(oCz3_battle12, ChangeToStandardFaction(GetObjectByTag("cz3_battle12", 0), 1));
			AssignCommand(oCz3_battle13, ChangeToStandardFaction(GetObjectByTag("cz3_battle13", 0), 1));
			AssignCommand(oCz3_battle14, ChangeToStandardFaction(GetObjectByTag("cz3_battle14", 0), 1));
			AssignCommand(oCz3_battle12, sub1(OBJECT_INVALID));
			AssignCommand(oCz3_battle13, sub1(OBJECT_INVALID));
			AssignCommand(oCz3_battle14, sub1(OBJECT_INVALID));
