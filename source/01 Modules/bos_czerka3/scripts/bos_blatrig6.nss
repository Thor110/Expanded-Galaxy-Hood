...
void main() {
	...
	if ((oNPC == GetEnteringObject())) {
		...
		if ((GetIsObjectValid(oCz3_main6) == 1)) {
			vector struct2 = Vector(113.08, 107.85, 0.0);
			location location1 = Location(struct2, 0.0);
			vector struct4 = Vector(115.49, 110.62, 0.0);
			location location3 = Location(struct4, 0.0);
			vector struct6 = Vector(102.06, 110.67, 0.0);
			location location5 = Location(struct6, 0.0);
			object oCz3_battle7 = GetObjectByTag("cz3_battle7", 0);
			object oCz3_battle8 = GetObjectByTag("cz3_battle8", 0);
			object oCz3_battle9 = GetObjectByTag("cz3_battle9", 0);
			CreateObject(1, "cz3_runneeeeeer", Location(Vector(112.34, 87.5, 0.0), 270.0), 0);
			AssignCommand(oCz3_battle7, ActionForceMoveToLocation(location1, 1, 30.0));
			AssignCommand(oCz3_battle8, ActionForceMoveToLocation(location3, 1, 30.0));
			AssignCommand(oCz3_battle9, ActionForceMoveToLocation(location5, 1, 30.0));
			AssignCommand(oCz3_battle7, sub1(OBJECT_INVALID));
			AssignCommand(oCz3_battle8, sub1(OBJECT_INVALID));
			AssignCommand(oCz3_battle9, sub1(OBJECT_INVALID));
			DelayCommand(2.0, AssignCommand(oCz3_battle7, ChangeToStandardFaction(GetObjectByTag("cz3_battle7", 0), 1)));
			DelayCommand(2.0, AssignCommand(oCz3_battle8, ChangeToStandardFaction(GetObjectByTag("cz3_battle8", 0), 1)));
			DelayCommand(2.0, AssignCommand(oCz3_battle9, ChangeToStandardFaction(GetObjectByTag("cz3_battle9", 0), 1)));
			CreateObject(1, "cz3_battle1", Location(Vector(114.8, 96.44, 0.0), 90.0), 0);
			CreateObject(1, "cz3_battle2", Location(Vector(111.38, 93.77, 0.0), 90.0), 0);
			CreateObject(1, "cz3_battle3", Location(Vector(100.21, 87.99, 0.0), 0.0), 0);
			CreateObject(1, "cz3_battle1", Location(Vector(90.47, 86.34, 0.0), 0.0), 0);
			CreateObject(1, "cz3_battle2", Location(Vector(83.09, 84.87, 0.0), 0.0), 0);
			CreateObject(1, "cz3_battle12", Location(Vector(66.92, 77.29, 0.0), 0.0), 0);
			CreateObject(1, "cz3_battle13", Location(Vector(53.86, 77.33, 0.0), 0.0), 0);
			CreateObject(1, "cz3_battle14", Location(Vector(49.93, 78.14, 0.0), 0.0), 0);
