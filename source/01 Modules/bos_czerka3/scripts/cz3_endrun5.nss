...
void main() {
	object oPC = GetFirstPC();
	vector struct2 = Vector(92.8, 109.87, 0.0);
	location location1 = Location(struct2, 0.0);
	vector struct4 = Vector(93.96, 108.03, 0.0);
	location location3 = Location(struct4, 0.0);
	vector struct6 = Vector(91.49, 111.82, 0.0);
	location location5 = Location(struct6, 0.0);
	object oCz3_battle4 = GetObjectByTag("cz3_battle4", 0);
	object oCz3_battle5 = GetObjectByTag("cz3_battle5", 0);
	object oCz3_battle6 = GetObjectByTag("cz3_battle6", 0);
	object oCz3_battle1 = GetObjectByTag("cz3_battle1", 0);
	object oCz3_battle2 = GetObjectByTag("cz3_battle2", 0);
	object oCz3_battle3 = GetObjectByTag("cz3_battle3", 0);
	CreateObject(1, "cz3_runneeeeeer", Location(Vector(112.34, 87.5, 0.0), 270.0), 0);
	AssignCommand(oCz3_battle4, ActionForceMoveToLocation(location1, 1, 30.0));
	AssignCommand(oCz3_battle5, ActionForceMoveToLocation(location3, 1, 30.0));
	AssignCommand(oCz3_battle6, ActionForceMoveToLocation(location5, 1, 30.0));
	AssignCommand(oCz3_battle4, sub1(OBJECT_INVALID));
	AssignCommand(oCz3_battle5, sub1(OBJECT_INVALID));
	AssignCommand(oCz3_battle6, sub1(OBJECT_INVALID));
	AssignCommand(oCz3_battle1, sub1(OBJECT_INVALID));
	AssignCommand(oCz3_battle2, sub1(OBJECT_INVALID));
	AssignCommand(oCz3_battle3, sub1(OBJECT_INVALID));
}
