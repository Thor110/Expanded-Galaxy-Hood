...
void main() {
	...
	if ((oCz3_battle7 == GetEnteringObject())) {
		object object10 = GetObjectByTag("cz3_battle7", 0);
		object object12 = GetObjectByTag("cz3_battle8", 0);
		object object14 = GetObjectByTag("cz3_battle9", 0);
		AssignCommand(object10, ChangeToStandardFaction(GetObjectByTag("cz3_battle7", 0), 1));
		AssignCommand(object12, ChangeToStandardFaction(GetObjectByTag("cz3_battle8", 0), 1));
		AssignCommand(object14, ChangeToStandardFaction(GetObjectByTag("cz3_battle9", 0), 1));
	}
	if ((oNPC == GetEnteringObject())) {
		object oCz3_main6 = GetObjectByTag("cz3_main6", 0);
		if ((GetIsObjectValid(oCz3_main6) == 1)) {
			vector struct2 = Vector(121.33, 94.0, 0.0);
			location location1 = Location(struct2, 0.0);
			vector struct4 = Vector(112.47, 87.34, 0.0);
			location location3 = Location(struct4, 0.0);
			object oCz3_battle10 = GetObjectByTag("cz3_battle10", 0);
			object oCz3_battle11 = GetObjectByTag("cz3_battle11", 0);
			CreateObject(1, "cz3_runneeeeeer", Location(Vector(112.34, 87.5, 0.0), 270.0), 0);
			AssignCommand(oCz3_battle10, ActionForceMoveToLocation(location1, 1, 30.0));
			AssignCommand(oCz3_battle11, ActionForceMoveToLocation(location3, 1, 30.0));
			AssignCommand(oCz3_battle10, sub1(OBJECT_INVALID));
			AssignCommand(oCz3_battle11, sub1(OBJECT_INVALID));
			DelayCommand(2.0, AssignCommand(oCz3_battle10, ChangeToStandardFaction(GetObjectByTag("cz3_battle10", 0), 1)));
			AssignCommand(oCz3_battle11, ChangeToStandardFaction(GetObjectByTag("cz3_battle11", 0), 1));
