...
del "Expanded Galaxy Hood Installer\tslpatchdata\changes-gog-legacy.ini"
...
type changes\changes-gog-legacy-intro.ini	changes\changes.ini changes\changes-outro.ini	override.txt > "Expanded Galaxy Hood Installer\tslpatchdata\changes-gog-legacy.ini"
