void main() {
	...
	if ((GetIsObjectValid(GetObjectByTag("bos_roosh", 0)) == 1)) {
		DestroyObject(GetObjectByTag("wp_bos_nat_01", 0), 0.0, 0, 0.0);
		DestroyObject(GetObjectByTag("wp_bos_nat_02", 0), 0.0, 0, 0.0);
	}
}
