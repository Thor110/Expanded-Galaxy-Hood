...
pause
echo Installing Expanded Galaxy Project Brotherhood

:: Call executable based on chosen path
if exist "tslpatchdata\pykotorcli.exe" (
	copy /y "source\template\k_pkor_33arenter.ncs" "%KOTORPaths%\Override\k_pkor_33arenter.ncs.port"
	copy /y "source\template\k_ptat17af_enter.ncs" "%KOTORPaths%\Override\k_ptat17af_enter.ncs.port"
	copy /y "source\template\k_ptat17_enter.ncs" "%KOTORPaths%\Override\k_ptat17_enter.ncs.port"
	copy /y "source\template\k_ptat18ac_enter.ncs" "%KOTORPaths%\Override\k_ptat18ac_enter.ncs.port"
	ren "%KOTORPaths%\movies\ObsidianEnt.bik" "ObsidianEnt.bik.port"
	copy /y "tslpatchdata\launcher.bat" "%KOTORPaths%\launcher.bat"
    call "tslpatchdata\pykotorcli.exe" "%KOTORPaths%" "%cd%"
	copy /y "brotherhood-patch-notes.rtf" "%KOTORPaths%\brotherhood-patch-notes.rtf"
	copy /y "brotherhood-readme.rtf" "%KOTORPaths%\brotherhood-readme.rtf"
