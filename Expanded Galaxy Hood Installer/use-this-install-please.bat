...
copy /y "%mykeyB%\Override\appearance.2da" "appearance.2da.port"
copy /y "%mykeyB%\Override\portraits.2da" "heads.2da.port"
copy /y "%mykeyB%\Override\heads.2da" "portraits.2da.port"
