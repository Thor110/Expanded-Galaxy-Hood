...
void main() {
	object oNPC = GetPartyMemberByIndex(0);
	vector struct2 = Vector(136.76, 154.08, 9.0);
	location location1 = Location(struct2, 0.0);
	vector struct4 = Vector(137.23, 156.3, 9.0);
	location location3 = Location(struct4, 0.0);
	object oMsp_mand11 = GetObjectByTag("msp_mand11", 0);
	if ((oMsp_mand11 == GetEnteringObject())) {
		object oMsp_topdoor2 = GetObjectByTag("msp_topdoor2", 0);
		AssignCommand(oMsp_topdoor2, ActionCloseDoor(oMsp_topdoor2));
		AssignCommand(oMsp_topdoor2, SetLocked(oMsp_topdoor2, 1));
		object object8 = GetObjectByTag("msp_mand11", 0);
		object oMsp_mand12 = GetObjectByTag("msp_mand12", 0);
		AssignCommand(object8, ActionDoCommand(SetCommandable(1, object8)));
		AssignCommand(oMsp_mand12, ActionDoCommand(SetCommandable(1, oMsp_mand12)));
		AssignCommand(object8, sub1(OBJECT_INVALID));
