...
void main() {
	...
	ChangeToStandardFaction(GetObjectByTag("cz4_gangtlkr1b", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("cz4_gangtlkr2b", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("cz4_gangtlkr3b", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("cz4_gangtlkr4b", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("cz4_gangwaiter1b", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("cz4_gangwaiter2b", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("cz4_manager", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("cz4_doorguy1", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("cz4_doorguy2", 0), 1);
	AssignCommand(oCz4_gangtlkr1b, sub1(OBJECT_INVALID));
	AssignCommand(oCz4_gangtlkr2b, sub1(OBJECT_INVALID));
	AssignCommand(oCz4_gangtlkr3b, sub1(OBJECT_INVALID));
	AssignCommand(oCz4_gangtlkr4b, sub1(OBJECT_INVALID));
	AssignCommand(oCz4_gangwaiter1b, sub1(OBJECT_INVALID));
	AssignCommand(oCz4_gangwaiter2b, sub1(OBJECT_INVALID));
	AssignCommand(oCz4_manager, sub1(OBJECT_INVALID));
}
