...
void main() {
	ChangeToStandardFaction(GetObjectByTag("mand_comm", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("mand_cap1", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("mand_cap2", 0), 1);
	...
	AssignCommand(oTaris_fighter1, ActionMoveToObject(oMand_comm, 1, 5.0));
	AssignCommand(oTaris_fighter2, ActionMoveToObject(oMand_comm, 1, 6.0));
	AssignCommand(oTaris_fighter3, ActionMoveToObject(oMand_comm, 1, 8.0));
	AssignCommand(oTaris_fighter4, ActionMoveToObject(oMand_comm, 1, 3.0));
	AssignCommand(oTaris_fighter5, ActionMoveToObject(oMand_comm, 1, 4.0));
	AssignCommand(oTaris_fighter6, ActionMoveToObject(oMand_comm, 1, 5.0));
	AssignCommand(oTaris_fighter7, ActionMoveToObject(oMand_comm, 1, 2.0));
	AssignCommand(oTaris_fighter8, ActionMoveToObject(oMand_comm, 1, 1.0));
	AssignCommand(oTaris_fighter1, ActionDoCommand(ExecuteScript("k_ai_master", OBJECT_SELF, 1005)));
	AssignCommand(oTaris_fighter2, ActionDoCommand(ExecuteScript("k_ai_master", OBJECT_SELF, 1005)));
	AssignCommand(oTaris_fighter3, ActionDoCommand(ExecuteScript("k_ai_master", OBJECT_SELF, 1005)));
	AssignCommand(oTaris_fighter4, ActionDoCommand(ExecuteScript("k_ai_master", OBJECT_SELF, 1005)));
	AssignCommand(oTaris_fighter5, ActionDoCommand(ExecuteScript("k_ai_master", OBJECT_SELF, 1005)));
	AssignCommand(oTaris_fighter6, ActionDoCommand(ExecuteScript("k_ai_master", OBJECT_SELF, 1005)));
	AssignCommand(oTaris_fighter7, ActionDoCommand(ExecuteScript("k_ai_master", OBJECT_SELF, 1005)));
	AssignCommand(oTaris_fighter8, ActionDoCommand(ExecuteScript("k_ai_master", OBJECT_SELF, 1005)));
	AssignCommand(oTaris_sol1, sub1(OBJECT_INVALID));
	AssignCommand(oTaris_sol2, sub1(OBJECT_INVALID));
	SetPlotFlag(oTaris_sol1, 0);
	SetPlotFlag(oTaris_sol2, 0);
	SetMinOneHP(oTaris_sol2, 0);
	SetMinOneHP(oTaris_sol1, 0);
}
