...
void main() {
	...
	object oNPC = GetPartyMemberByIndex(0);
	object oTun_channa = GetObjectByTag("tun_channa", 0);
	vector struct2 = Vector(62.09, 151.22, 5.77);
	location location1 = Location(struct2, 0.0);
	vector struct4 = Vector(122.13, 125.97, 5.77);
	...
	if ((oNPC == GetEnteringObject())) {
		...
		object oTun_carth = GetObjectByTag("tun_carth", 0);
		...
		AssignCommand(oTun_channa, ActionDoCommand(SetCommandable(0, oTun_channa)));
		AssignCommand(oTun_channa, ActionForceMoveToLocation(location1, 1, 30.0));
		AssignCommand(oTun_channa, ActionForceMoveToLocation(location3, 1, 30.0));
		AssignCommand(oTun_channa, ActionDoCommand(DestroyObject(oTun_channa, 0.0, 0, 0.0)));
	}
}
