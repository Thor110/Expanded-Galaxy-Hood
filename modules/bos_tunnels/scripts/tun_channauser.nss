...
void main() {
	...
	if ((int2 == 1006)) {
		...
		if ((nCurHP < 10)) {
			...
			MusicBackgroundChangeDay(oArea, int5);
			MusicBackgroundChangeNight(oArea, int5);
			MusicBackgroundPlay(oArea);
			object oTun_guy = GetObjectByTag("tun_guy", 0);
			SetGlobalFadeOut(3.0, 3.0, 0.0, 0.0, 0.0);
			AssignCommand(oTun_guy, ActionWait(6.5));
			AssignCommand(oTun_guy, ActionStartConversation(oTun_guy, "tun_end", 0, 0, 0, "", "", "", "", "", "", 0));
		}
	}
}
