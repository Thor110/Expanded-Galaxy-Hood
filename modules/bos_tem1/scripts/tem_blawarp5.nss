void main() {
	...
	ActionWait(2.0);
	vector struct2 = Vector(29.18, 73.55, 9.0);
	location location1 = Location(struct2, 180.0);
	vector struct4 = Vector(29.18, 75.07, 9.0);
	location location3 = Location(struct4, 180.0);
	vector struct6 = Vector(29.18, 73.8, 9.0);
	location location5 = Location(struct6, 180.0);
	vector struct8 = Vector(31.39, 75.47, 9.0);
	location location7 = Location(struct8, 180.0);
	vector struct10 = Vector(32.51, 75.42, 9.0);
