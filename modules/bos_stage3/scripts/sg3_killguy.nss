...
void main() {
	...
	AssignCommand(oSg1_sin, ActionForceMoveToLocation(Location(Vector(278.03, 54.97, 0.0), 0.0), 1, 30.0));
	...
	ChangeToStandardFaction(GetObjectByTag("sg3_sith1", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("sg3_sith2", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("sg3_sith3", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("sg3_sith4", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("sg3_sith5", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("sg3_sith6", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("sg3_sith7", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("sg3_sith8", 0), 1);
	...
	DelayCommand(1.0, ExecuteScript("k_ai_master", oSg3_sith1, 1005));
	DelayCommand(1.0, ExecuteScript("k_ai_master", oSg3_sith2, 1005));
	DelayCommand(1.0, ExecuteScript("k_ai_master", oSg3_sith3, 1005));
	DelayCommand(1.0, ExecuteScript("k_ai_master", oSg3_sith4, 1005));
	DelayCommand(1.0, ExecuteScript("k_ai_master", oSg3_sith5, 1005));
	DelayCommand(1.0, ExecuteScript("k_ai_master", oSg3_sith6, 1005));
	DelayCommand(1.0, ExecuteScript("k_ai_master", oSg3_sith7, 1005));
	DelayCommand(1.0, ExecuteScript("k_ai_master", oSg3_sith8, 1005));
	AssignCommand(oSg3_sith1, sub1(OBJECT_INVALID));
	AssignCommand(oSg3_sith2, sub1(OBJECT_INVALID));
	AssignCommand(oSg3_sith3, sub1(OBJECT_INVALID));
	AssignCommand(oSg3_sith4, sub1(OBJECT_INVALID));
	AssignCommand(oSg3_sith5, sub1(OBJECT_INVALID));
	AssignCommand(oSg3_sith6, sub1(OBJECT_INVALID));
	AssignCommand(oSg3_sith7, sub1(OBJECT_INVALID));
	AssignCommand(oSg3_sith8, sub1(OBJECT_INVALID));
	object oTun_guy = GetObjectByTag("tun_guy", 0);
	object oTun_guy2 = GetObjectByTag("tun_guy2", 0);
	AssignCommand(oTun_guy, ActionWait(3.0));
	AssignCommand(oTun_guy, ActionStartConversation(oTun_guy2, "sg3_sin", 0, 0, 0, "", "", "", "", "", "", 0));
}
