...
void main() {
	...
	if ((oPC == GetEnteringObject())) {
		object oSwr_bladoor = GetObjectByTag("swr_bladoor", 0);
		AssignCommand(oSwr_bladoor, ActionOpenDoor(oSwr_bladoor));
		...
		ChangeToStandardFaction(GetObjectByTag("swr_gang1", 0), 1);
		ChangeToStandardFaction(GetObjectByTag("swr_gang2", 0), 1);
		ChangeToStandardFaction(GetObjectByTag("swr_gang3", 0), 1);
		ChangeToStandardFaction(GetObjectByTag("swr_gang4", 0), 1);
		ChangeToStandardFaction(GetObjectByTag("swr_gang5", 0), 1);
		AssignCommand(oSwr_gang1, sub1(OBJECT_INVALID));
		AssignCommand(oSwr_gang2, sub1(OBJECT_INVALID));
		AssignCommand(oSwr_gang3, sub1(OBJECT_INVALID));
		AssignCommand(oSwr_gang4, sub1(OBJECT_INVALID));
		AssignCommand(oSwr_gang5, sub1(OBJECT_INVALID));
