...
void main() {
	...
	ChangeToStandardFaction(GetObjectByTag("bos_sith", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("bos_sith2", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("bos_sith3", 0), 1);
	AssignCommand(oBos_sith, sub1(OBJECT_INVALID));
	AssignCommand(oBos_sith2, sub1(OBJECT_INVALID));
	AssignCommand(oBos_sith3, sub1(OBJECT_INVALID));
