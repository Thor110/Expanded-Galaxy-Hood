...
void main() {
	object oNPC = GetPartyMemberByIndex(0);
	vector struct2 = Vector(61.84, 37.23, 3.0);
	location location1 = Location(struct2, 0.0);
	vector struct4 = Vector(63.94, 37.08, 9.0);
	...
	if ((oNPC == GetEnteringObject())) {
		...
		AssignCommand(oMsp_mand14, ActionForceMoveToLocation(location1, 1, 30.0));
		AssignCommand(oMsp_mand15, ActionForceMoveToLocation(location3, 1, 30.0));
