...
void main() {
	...
	object oCanderous = GetObjectByTag("Canderous", 0);
	object oJolee = GetObjectByTag("Jolee", 0);
	object oJuhani = GetObjectByTag("Juhani", 0);
	CreateObject(1, "tun_channa2c", Location(Vector(158.09, 185.48, 0.0), 180.0), 0);
	AssignCommand(oTun_starter, ChangeToStandardFaction(GetObjectByTag("Carth", 0), 1));
	AssignCommand(oTun_starter, ChangeToStandardFaction(GetObjectByTag("Mission", 0), 1));
	AssignCommand(oTun_starter, ChangeToStandardFaction(GetObjectByTag("Zaalbar", 0), 1));
	AssignCommand(oTun_starter, ChangeToStandardFaction(GetObjectByTag("Canderous", 0), 1));
	AssignCommand(oTun_starter, ChangeToStandardFaction(GetObjectByTag("Jolee", 0), 1));
	AssignCommand(oTun_starter, ChangeToStandardFaction(GetObjectByTag("Juhani", 0), 1));
	AssignCommand(oCarth, sub1(OBJECT_INVALID));
	AssignCommand(oMission, sub1(OBJECT_INVALID));
	AssignCommand(oZaalbar, sub1(OBJECT_INVALID));
	AssignCommand(oCanderous, sub1(OBJECT_INVALID));
	AssignCommand(oJolee, sub1(OBJECT_INVALID));
	AssignCommand(oJuhani, sub1(OBJECT_INVALID));
	AssignCommand(oTun_starter, ActionDoCommand(DestroyObject(oTun_starter, 0.0, 0, 0.0)));
}
