...
void main() {
	...
	object object31 = GetObjectByTag("tun_guy", 0);
	object object33 = GetObjectByTag("tun_guy2", 0);
	object oSg1_lol = GetObjectByTag("sg1_lol", 0);
	if (((((((((((GetIsObjectValid(oSg3_sith1) == 0) && (GetIsObjectValid(oSg3_sith2) == 0)) && (GetIsObjectValid(oSg3_sith3) == 0)) && (GetIsObjectValid(oSg3_sith4) == 0)) && (GetIsObjectValid(oSg3_sith5) == 0)) && (GetIsObjectValid(oSg3_sith6) == 0)) && (GetIsObjectValid(oSg3_sith7) == 0)) && (GetIsObjectValid(oSg3_sith8) == 0)) && (GetIsObjectValid(oSg1_lol) == 1)) && (GetIsObjectValid(oTem_bla) == 0))) {
		SetPlotFlag(oSg1_sin, 0);
		sub1(oSg1_sin, 3.0);
		AssignCommand(oTun_guy, ActionStartConversation(oTun_guy2, "sg3_sin2", 0, 0, 0, "", "", "", "", "", "", 0));
		AssignCommand(oSg1_lol, ActionDoCommand(DestroyObject(oSg1_lol, 0.0, 0, 0.0)));
		DelayCommand(4.0, ExecuteScript("k_ai_master", oSg1_sin, 1005));
	}
}
