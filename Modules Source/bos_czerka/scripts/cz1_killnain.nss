...
void main() {
	...
	ChangeToStandardFaction(GetObjectByTag("bos_nain", 0), 1);
	AssignCommand(oBos_nain, sub1(OBJECT_INVALID));
	SetGlobalNumber("Tar_YunGend", 13);
	CreateObject(64, "cz1_screw1", Location(Vector(89.71, 95.63, 0.0), 0.0), 0);
}
