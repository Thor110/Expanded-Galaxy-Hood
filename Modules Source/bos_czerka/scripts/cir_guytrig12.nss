...
void main() {
	...
	if ((GetTag(oEntering) == "bos_walker5")) {
		...
		AssignCommand(oEntering, ActionForceMoveToLocation(Location(Vector(56.72, 105.72, 0.0), 0.0), 0, 30.0));
		AssignCommand(oEntering, ActionDoCommand(SetFacing(180.0)));
		AssignCommand(oEntering, ActionWait(3.0));
		AssignCommand(oEntering, ActionPlayAnimation(10, 1.0, 3.0));
		AssignCommand(oEntering, ActionWait(3.0));
		AssignCommand(oEntering, ActionPlayAnimation(10, 1.0, 3.0));
		AssignCommand(oEntering, ActionWait(4.0));
