...
void main() {
	object oNPC = GetPartyMemberByIndex(0);
	vector struct2 = Vector(77.25, 156.16, 6.0);
	location location1 = Location(struct2, 0.0);
	vector struct4 = Vector(77.11, 154.18, 6.0);
	location location3 = Location(struct4, 0.0);
	object oMsp_blatrig8 = GetObjectByTag("msp_blatrig8", 0);
	object oMsp_malak = GetObjectByTag("msp_malak", 0);
	if ((oNPC == GetEnteringObject())) {
		object oMsp_mand16 = GetObjectByTag("msp_mand16", 0);
		object oMsp_mand17 = GetObjectByTag("msp_mand17", 0);
		AssignCommand(oMsp_mand16, ActionForceMoveToLocation(location1, 1, 30.0));
		AssignCommand(oMsp_mand17, ActionForceMoveToLocation(location3, 1, 30.0));
		...
		AssignCommand(oMsp_mand17, ChangeToStandardFaction(GetObjectByTag("msp_mand17", 0), 1));
		AssignCommand(oMsp_mand17, sub1(OBJECT_INVALID));
		AssignCommand(oMsp_blatrig8, ActionDoCommand(DestroyObject(oMsp_blatrig8, 0.0, 0, 0.0)));
	}
}
