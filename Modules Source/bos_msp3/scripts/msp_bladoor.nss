...
void main() {
	vector struct2 = Vector(187.85, 56.31, 3.0);
	location location1 = Location(struct2, 0.0);
	vector struct4 = Vector(187.85, 53.85, 3.0);
	location location3 = Location(struct4, 0.0);
	object oMand_comm1 = GetObjectByTag("mand_comm1", 0);
	object oMand_comm2 = GetObjectByTag("mand_comm2", 0);
	AssignCommand(oMand_comm1, ActionForceMoveToLocation(location1, 1, 30.0));
	AssignCommand(oMand_comm2, ActionForceMoveToLocation(location3, 1, 30.0));
	AssignCommand(oMand_comm1, ChangeToStandardFaction(GetObjectByTag("mand_comm1", 0), 1));
	AssignCommand(oMand_comm1, sub1(OBJECT_INVALID));
	AssignCommand(oMand_comm2, ChangeToStandardFaction(GetObjectByTag("mand_comm2", 0), 1));
	AssignCommand(oMand_comm2, sub1(OBJECT_INVALID));
}
