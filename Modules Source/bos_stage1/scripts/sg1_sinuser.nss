...
void main() {
	...
	if ((int2 == 1006)) {
		...
		object object19 = GetObjectByTag("sg1_jedi1", 0);
		int1 = GetCurrentHitPoints(OBJECT_SELF);
		object object21 = GetObjectByTag("tun_guy", 0);
		object object23 = GetObjectByTag("tun_guy2", 0);
		object oSg1_lol = GetObjectByTag("sg1_lol", 0);
		if ((int1 <= 10)) {
			object object27 = GetFirstPC();
			...
			AssignCommand(object27, ClearAllEffects());
			object object29 = GetObjectByTag("tun_guy", 0);
			ActionDoCommand(DestroyObject(OBJECT_SELF, 0.0, 0, 0.0));
			SetGlobalFadeOut(3.0, 4.0, 0.0, 0.0, 0.0);
			AssignCommand(object29, ActionWait(7.0));
			AssignCommand(object29, ActionStartConversation(object27, "sg1_end", 0, 0, 0, "", "", "", "", "", "", 0));
		}
	}
}
