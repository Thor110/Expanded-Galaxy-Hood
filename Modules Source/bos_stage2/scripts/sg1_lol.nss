...
void main() {
	...
	object object27 = GetObjectByTag("tun_guy", 0);
	object object29 = GetObjectByTag("tun_guy2", 0);
	object oSg1_lol = GetObjectByTag("sg1_lol", 0);
	if (((((((((GetIsObjectValid(oSg2_mand1) == 0) && (GetIsObjectValid(oSg2_mand2) == 0)) && (GetIsObjectValid(oSg2_mand3) == 0)) && (GetIsObjectValid(oSg2_mand4) == 0)) && (GetIsObjectValid(oSg2_mand5) == 0)) && (GetIsObjectValid(oSg2_mand6) == 0)) && (GetIsObjectValid(oSg1_lol) == 1)) && (GetIsObjectValid(oTem_bla) == 0))) {
		SetPlotFlag(oSg1_sin, 0);
		sub1(oSg1_sin, 3.0);
		AssignCommand(oTun_guy, ActionStartConversation(oTun_guy2, "sg2_sin2", 0, 0, 0, "", "", "", "", "", "", 0));
